...
UClass* UCPP_GameInstance::GetAssetClassBySoftReference(const TAssetSubclassOf<AActor>& AssetPointer)
{
...
UClass* UCPP_GameInstance::GetWidgetClassBySoftReference(const TAssetSubclassOf<UUserWidget>& WidgetPointer)
{
