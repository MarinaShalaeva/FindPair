 ...
 * level settings before starting the new game (new level).
 */
UCLASS(Abstract)
...
protected:
	...
	/**
	 * Array of checkboxes intended to
	 * different cards' styles.
	 */
	UPROPERTY()
	TArray<UCheckBox*> CardsStylesCheckBoxes;

	/**
	 * Checkbox for Halloween style of
	 * cards.
	 */
	...
	/**
	 * Checkbox for Cleaning style of
	 * cards.
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	...
	/**
	 * Checkbox for Valentines style of
	 * cards.
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	...
	/**
	 * Text block for displaying the number of
	 * pairs. 
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	...
	/**
	 * Button to choose all cards' styles
	 * or cancel the choice of all cards' styles
	 * (styles that will be used during level).
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	...
	/**
	 * Text block that will be display in
	 * the center of ChooseAllCardsStylesButton.
	 * Should indicate what action will be performed
	 * when the button is clicked: choosing all
	 * cards' styles or canceling this selection.
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	UTextBlock* ChooseAllCardsStylesTextBlock;

	/**
	 * Inscription for choosing all cards'
	 * styles.
	 */
	...
	/**
	 * Inscription for canceling the selection
	 * of all cards' styles.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
...
private:
	/**
	 * Does current inscription match the
	 * ChooseAllCardsStylesText?
	 */
...
protected:
	/**
	 * Function to set suitable checkboxes' states
	 * to true by input cards' styles array.
	...
	/**
	 * Function for changing "change pairs
	 * number" slider's value.
	...
	/**
	 * Function for choosing all cards'
	 * styles.
	 */
	UFUNCTION()
	...
	/**
	 * Function for canceling the selection
	 * of all cards' styles.
	 */
	UFUNCTION()
	...
	/**
	 * Function that contains logic that should be
	 * applied when any style checkbox changes its state.
	...
	/**
	 * Function for changing opportunity to start new
	 * level (changing enabling of "Start new level" button).
	...
	/**
	 * Function that contains logic that should be
	 * applied when ClassicModeCheckBox changes its state.
	 * @param bIsChecked Is the new value of checkbox true?
	 */
	UFUNCTION(BlueprintCallable)
	...
	/**
	 * Function that contains logic that should be
	 * applied when TimeReductionModeCheckBox changes its
	 * state.
	 * @param bIsChecked Is the new value of checkbox true?
	 */
	UFUNCTION(BlueprintCallable)
...
private:
	/**
	 * Function that returns chosen on this panel
	 * level's settings.
