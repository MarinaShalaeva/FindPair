...
/**
 * Library with static functions for working with
 * widgets.
 */
UCLASS()
...
public:
	...
	/**
	 * Function for getting a pointer (soft reference)
	 * to widget blueprint from data table by the name
	 * of the row.
	 * @param DataTable Data table with the list of
	 * available widget blueprints.
	 * @param Row The name of the row from data table,
	 * by which we should find information.
	 * @return Soft reference to the widget blueprint.
	 */
	static TAssetSubclassOf<UUserWidget> GetSoftReferenceToWidgetBlueprintByRowName(
