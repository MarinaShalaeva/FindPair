...
protected:
	...
	/**
	 * Scroll box for showing all player's
	 * results.
	 */
	...
	/**
	 * Name of the time reduction level
	 * mode.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	...
	/**
	 * Font style for recently created
	 * text blocks.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	FSlateFontInfo Font;
...
private:
	...
	/**
	 * Function for updating the style
	 * of the text block.
	 * @param TextBlock Reference to text block
