...
protected:
	...
	/**
	 * USoundClass object reference for changing
	 * music settings.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Override Classes")
	USoundClass* Music_SoundClass = nullptr;
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Override Classes")
	USoundClass* SFX_SoundClass = nullptr;
...
private:
	 ...
	 */
	bool bMusicVolumeIsZero = false;

	/**
	 * Timer for turning on the track list
	 * looping.
	 */
...
private:
	/**
	 * Number of widgets that contain tracks'
	 * names.
	 */
	UPROPERTY()
...
protected:
	/**
	 * Widget switcher containing all tracks'
	 * names.
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	...
	/**
	 * Button to switch the current track to
	 * the previous one. 
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
...
private:
	...
	/**
	 * Function that is called after
	 * music volume slider value was changed.
	...
	/**
	 * Function that is called after
	 * SFX volume slider value was changed.
	 * @param Val New slider value.
	 */
	UFUNCTION()
	...
	/**
	 * Function that is called after
	 * changing the current music track to
	 * another one. 
	 * @param TrackNumber New selected track
	 * number.
	 */
	void TrackWasSwitched(int32 TrackNumber);

	/**
	 * Function for switching the current
	 * track to the previous one.
	 * Function is called after clicking on
	 * LeftArrowAudioTrackButton.
	 */
	UFUNCTION()
	 ...
	 * Function is called after clicking on
	 * RightArrowAudioTrackButton.
	 */
	UFUNCTION()
	void RightArrowAudioTrackButtonOnClicked();

	/**
	 * Function for turning on the looping
	 * of music tracks' list.
	 */
