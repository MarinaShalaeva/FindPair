...
protected:
	...
	/**
	 * Function for storing logic that should be
	 * applied when the actor appears in the game
	 * world.
	 */
	...
	/**
	 * Function for storing logic that should be
	 * applied in the end of the actor's life
	 * (but before its destroying).
	 * @param EndPlayReason Specifies why an actor
	 * is being deleted/removed from a level.
	 */
...
public:
	...
	/**
	 * Function for initializing necessary widgets
	 * after the level's starting.
	 ...
	 * that was spent for completing the level.
	 */
	UFUNCTION()
	 ...
	 * performed during playing this level.
	 * @param SpentSeconds Number of seconds
	 * that was spent for completing the level.
	 * @param bSuccess Player won?
	 */
	...
	/**
	 * Function for creating Pause Widget
	 * and for calling the Player Controller's
	...
	/**
	 * Function for destroying Pause Widget
	 * and for calling the Player Controller's
	 * «End Pause» function.
	 */
	UFUNCTION()
	...
	/**
	 * Function for destroying unnecessary widgets
	 * and for calling the Player Controller's «Restart
	 * Current Game» function.
	 */
	UFUNCTION()
	void RestartCurrentGame();

	/**
	 * Function for creating Main Menu widget
	 * and for calling the Player Controller's «Return
