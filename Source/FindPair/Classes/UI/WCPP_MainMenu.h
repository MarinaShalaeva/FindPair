...
private:
	...
	/**
	 * Reference to current Configure Level Params
	 * widget blueprint.
	 */
	UPROPERTY()
	...
	/**
	 * Reference to current Player Results widget
	 * blueprint.
	 */
	UPROPERTY()
	...
	/**
	 * Reference to current Game Info widget
	 * blueprint.
	 */
	UPROPERTY()
...
protected:
	//============Inscriptions====================
	/**
	 * Text block for the caption at the
	 * top of the widget, containing information
	 * about current opened panel.
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	UTextBlock* UpInscriptionTextBlock;

	/**
	 * Variable containing the main menu
	 * inscription.
	 */
	...
	/**
	 * Variable containing the level's
	...
	/**
	 * Variable containing the settings
	 * inscription.
	 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Inscriptions")
	...
	/**
	 * Variable containing the player's
	 * results inscription.
	 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Inscriptions")
	...
	/**
	 * Variable containing the information
	 * about the game inscription.
	 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Inscriptions")
	...
	/**
	 * Widget switcher containing all
	 * necessary for the main menu panels.
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	...
	/**
	 * Size box for information about the
	 * game panel.
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	...
	/**
	 * Button for switching to choosing
	...
	/**
	 * Button for switching to the player's
	 * results panel.
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	...
	/**
	 * Button for switching the information
	 * about the game panel.
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	UButton* InfoButton;
	...
	/**
	 * Button for returning to the main
	 * panel, containing the list of available
	 * buttons.
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	...
	/**
	 * Inscription for successful deleting
	 * of save file.
	 */
	...
	/**
	 * Inscription for unsuccessful deleting
	 * of save file.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Inscriptions")
	...
	/**
	 * Text block for the message about
	 * process of deleting the save file.
	 */
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	...
	/**
	 * Timer for showing information about
...
protected:
	/**
	 * Data Table with the list of soft references
	 * to all widgets' classes.
	 */
...
private:
	/**
	 * Function for changing current opened
	 * panel to the level's settings panel.
	 */
	UFUNCTION()
	...
	/**
	 * Function for destroying the level's
	 * settings panel.
	 */
	UFUNCTION()
	...
	/**
	 * Function for destroying the settings
	 * panel.
	 */
	UFUNCTION()
	...
	/**
	 * Function for changing current opened
	 * panel to the player's results panel.
	 */
	UFUNCTION()
	void SwitchToPlayerResultsPanel();

	/**
	 * Function for creating the player's
	 * results panel.
	 */
	UFUNCTION()
	...
	/**
	 * Function for destroying the player's
	 * results panel.
	 */
	UFUNCTION()
	...
	/**
	 * Function for changing current opened
	 * panel to the information about the game panel.
	 */
	UFUNCTION()
	void SwitchToInfoPanel();

	/**
	 * Function for creating the game's
	 * information panel.
	 */
	UFUNCTION()
	void InitInfoWidget();
	...
	/**
	 * Function for destroying the game's
	 * information panel.
	 */
	UFUNCTION()
	...
	/**
	 * Function for deleting the save file.
	 * Function is called after clicking on Delete
	 * Save Button.
	 */
	UFUNCTION()
	...
	/**
	 * Function for hide the message about
	 * process of deleting the save file.
	 */
	UFUNCTION()
	...
	/**
	 * Function for clearing the Show Deleting
	 * Info Timer.
	 */
	UFUNCTION()
	...
	/**
	 * Function for returning to the main
	 * panel, containing the list of available
	 * buttons.
	 * Function is called after clicking on Go Back
	 * Button.
	 */
	UFUNCTION()
	 ...
	 * Function is called after clicking on Exit
	 * Button.
	 */
	UFUNCTION()
	...
	/**
	 * Function changing go back button's
	 * visibility and enabling.
	 * @param bShouldBeVisible Should the go back
	 * button be visible and enabled?
	 */
	UFUNCTION()
	void ChangeGoBackButtonVisibility(bool bShouldBeVisible);

	/**
	 * Function for changing caption at the
	 * top of the widget.
