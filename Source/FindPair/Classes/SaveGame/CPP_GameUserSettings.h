...
/**
 * The child of UGameUserSettings for storing
 * settings, that are needed in "Find a pair"
 * game.
 */
UCLASS()
...
protected:
	/**
	 * The ordinal number of the current
	 * (or last played) audio track.
	 */
	UPROPERTY(Config)
...
public:
	/**
	 * Setter for the AudioTrackNumber
	 * variable.
	...
	/**
	 * Getter for the instance of UGameUserSettings
	 * class, casted to UCPP_GameUserSettings child class.
	 */
	UFUNCTION(BlueprintCallable)
