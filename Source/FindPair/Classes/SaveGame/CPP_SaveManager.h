...
/**
 * Class for working with Save Game object
 * (saving and loading game information,
 * creating and deleting save file, etc).
 */
UCLASS()
class FINDPAIR_API UCPP_SaveManager : public UObject
{
	...
	/**
	 * The name of the file that stores
	 * saved information about the game.
	 */
	UPROPERTY()
...
public:
	...
	/**
	 * Function for creating a Save Game object
	 * with information loaded from the save file, if
	 * the file exists. Otherwise, a new Save Game object
	 * will be created with variables that store default
	 * values.
	...
	/**
	 * Function for saving new player's result
	 * to the save file.
	 * @param bSuccess Player won?
	 * @param NumberOfPairs Number of pairs that were
	 * spawned for this level.
	 * @param LevelMode Current level mode.
	 * @param ClicksNumber Number of cards' spins
	 * performed during playing this level.
	 * @param Seconds Number of seconds that was
	 * spent for completing the level.
	 */
	UFUNCTION()
	...
	/**
	 * Function for loading player's results
	 * from the save file.
	 * @param Results Array of saved player's results.
	 * @return Loading information from file was
	 * successful?
	 */
	bool GetSavedPlayerResults(TArray<struct FPlayerResult>& Results);

	/**
	 * Function for saving last used level's
	 * settings to the save file.
	 * @param NumberOfPairs The last chosen number of
	 * pairs.
	 * @param LevelMode The last chosen level mode.
	 * @param CardsStyles The last chosen cards'
	 * styles.
	 */
	...
	/**
	 * Function for loading last used level's
	 * settings from the save file.
	 * @param NumberOfPairs The last chosen number of
	 * pairs.
	 * @param LevelMode The last chosen level mode.
	 * @param CardsStyles The last chosen cards'
	...
	/**
	 * Function for saving current Save Game
	 * object settings to file.
     * @return Saving process was successful?
	 */
	bool SaveGameInfoToFile();

	/**
	 * Function for deleting current save game
	 * file.
