...
/**
 * Delegate for notifying about ending of
...
protected:
	...
	/**
	 * The root component for storing all other
	...
	/**
	 * Audio Component for working with the first
	 * audio track.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Components | Audio", meta = (AllowPrivateAccess = true))
	UAudioComponent* TrackAudioComponent_0 = nullptr;

	/**
	 * Audio Component for working with the second
	 * audio track.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Components | Audio", meta = (AllowPrivateAccess = true))
	UAudioComponent* TrackAudioComponent_1 = nullptr;

	/**
	 * Audio Component for working with the third
	 * audio track.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Components | Audio", meta = (AllowPrivateAccess = true))
	UAudioComponent* TrackAudioComponent_2 = nullptr;
...
public:
	/**
	 * Delegate for notifying about ending of current
	 * playing track.
	 */
...
protected:
	/**
	 * Function that is called when any music track
	 * is finished playing.
	 */
	UFUNCTION()
...
public:
	/**
	 * Function for switching current track to the
	 * next one and for starting to play it.
	 */
	UFUNCTION()
	...
	/**
	 * Function for switching current track to the
	 * previous one and for starting to play it.
	 */
	UFUNCTION()
	void StartPlayingPreviousTrack();

	/**
	 * Function for stopping the current playing
	 * audio track.
	 */
	UFUNCTION()
	 ...
	 * track, if there are no playing tracks now).
	 */
	UFUNCTION()
