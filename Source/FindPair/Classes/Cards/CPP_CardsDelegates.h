...
/**
 * Delegate for notifying that player decided to
 * start new level.
 */
...
/**
 * Delegate for notifying that player opened one
 * card on the map.
 */
DECLARE_DELEGATE_OneParam(FCardWasOpenedByPlayer, ACPP_ParentCard* /*OpenedCard*/)

/**
 * Delegate for notifying that player tries to close
 * opened card.
 */
DECLARE_DELEGATE_OneParam(FPlayerTriesToCloseCard, ACPP_ParentCard* /*ClosedCard*/)

/**
 * Delegate for notifying that the cards have been
 * placed on the map.
 *
 * The Preview Time param means the number of seconds
 * during which all the cards on the map will be
 * opened. After this period of time, the cards
 * on the map will close and the game will start.
 */
...
/**
 * Delegate for notifying that the player opened
 * two suitable cards (found one another pair).
 */
DECLARE_DELEGATE(FOnePairWasFound);

/**
 * Delegate for notifying that the player decided to
 * skip preview period (period of time intended for
 * remember cards' locations).
 */
DECLARE_DELEGATE(FSkipCardsPreview);

/**
 * Delegate for getting number of seconds that was
...
/**
 * Delegate for notifying the Spawn Manager that all
 * cards, located on the map, should be destroyed.
 */
...
/**
 * Class for storing delegates, that may be needed to
 * work with cards.
 */
...
public:
	/**
	 * The delegate for notifying that player decided
	 * to start new level.
	 */
	...
	/**
	 * The delegate for notifying that player opened
	 * one card on the map.
	 */
	FCardWasOpenedByPlayer CardWasOpenedByPlayerDelegate;

	/**
	 * The delegate for notifying that player tries to
	 * close opened card.
	 */
	FPlayerTriesToCloseCard PlayerTriesToCloseCardDelegate;

	/**
	 * The delegate for notifying that the cards have
	...
	/**
	 * The delegate for getting number of seconds
	 * that was spent on searching for all the cards.
	 */
