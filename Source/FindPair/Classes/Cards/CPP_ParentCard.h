...
/**
 * Enumeration for storing current
 * card's state.
 */
UENUM()
...
/**
 * Class containing the logic of how one
 * card works for the "Find a pair" game.
 */
UCLASS()
...
protected:
	/**
	 * Function for specifying some variables
	 * after all the actor's components have been
	 * initialized.
	 */
	...
	/**
	 * The root component for storing
	 * all other components of the actor.
	 */
	UPROPERTY(VisibleAnywhere, Category = "Card Actor | Components", meta = (AllowPrivateAccess = true))
	USceneComponent* Root = nullptr;

	/**
	 * The static mesh component for
	 * the card.
	 */
	UPROPERTY(VisibleAnywhere, Category = "Card Actor | Components", meta = (AllowPrivateAccess = true))
	...
	/**
	 * The paper sprite component for
	 * storing the card's image.
	 */
...
protected:
	...
	/**
	 * ID to distinguish one card from
	 * another.
	 */
	...
	/**
	 * Reference to sound that should be
	 * played when user opens the card.
	 */
...
protected:
	/**
	 * Delegate for playing animation
	 * of opening and closing the card.
	 */
	FOnTimelineFloat TimelineProgressDelegate;

	/**
	 * Timeline for playing animation
	 * of opening and closing the card.
	 */
	UPROPERTY()
...
private:
	/**
	 * Start card's rotation for
	 * playing animation of opening and
	 * closing the card.
	 */
	FRotator StartRotation;

	/**
	 * End card's rotation for
	 * playing animation of opening and
	 * closing the card.
	 */
	...
	/**
	 * Function for opening or closing
	 * card, which will be called every frame
	 * during animation's playing.
	 * @param Value float value for the card's
...
public:
	/**
	 * Setter for the CardsDelegatesRef
	 * variable.
	...
	/**
	 * Function that response to clicking on
	 * card's static mesh.
	...
	/**
	 * Function for setting to material
	 * instance to card's back side.
	...
	/**
	 * Function that calls changing of the card's
	 * state to "Opened" and for launches the opening animation. 
	 */
	void OpenCard();
	/**
	 * Function that calls changing of the card's
	 * state to "Closed" and launches the closing animation. 
	 */
	void CloseCard();
	/**
	 * Function for changing card's state
	 * to "Was Found".
	 */
	void CardWasFound();
	/**
