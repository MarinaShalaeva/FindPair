...
private:
	 ...
	 * bound to a StartGameDelegate.
	 */
	FDelegateHandle StartGameDelegateHandle;
	
public:
	/**
	 * Delegate (event dispatcher) for changing
	 * sky material.
	 */
...
protected:
	...
	/**
	 * Reference to the instance of
	 * UCPP_SpawnCardsManager class.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UCPP_SpawnCardsManager* SpawnCardsManager;

	/**
	 * Material instance of universal card's back,
	 * which can be used if several cards' styles are selected.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UMaterialInstance* MI_GeneralCardBack;

	/**
	 * Data Table with cards' classes related to Halloween style.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UDataTable* HalloweenCardsDataTable;

	/**
	 * Data Table with cards' classes related to Autumn style.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UDataTable* AutumnCardsDataTable;

	/**
	 * Data Table with cards' classes related to Winter style.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UDataTable* WinterCardsDataTable;

	/**
	 * Data Table with cards' classes related to Bakery style.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UDataTable* BakeryCardsDataTable;

	/**
	 * Data Table with cards' classes related to Sport style.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UDataTable* SportCardsDataTable;

	/**
	 * Data Table with cards' classes related to Cleaning style.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UDataTable* CleaningCardsDataTable;

	/**
	 * Data Table with cards' classes related to Covid style.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UDataTable* CovidCardsDataTable;

	/**
	 * Data Table with cards' classes related to Flowers style.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UDataTable* FlowersCardsDataTable;

	/**
	 * Data Table with cards' classes related to Spring style.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UDataTable* SpringCardsDataTable;

	/**
	 * Data Table with cards' classes related to Summer style.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UDataTable* SummerCardsDataTable;

	/**
	 * Data Table with cards' classes related to Valentines style.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UDataTable* ValentinesCardsDataTable;

	/**
	 * Data Table with cards' classes related to School style.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cards")
	UDataTable* SchoolCardsDataTable;

	/**
	 * Data Table with sky materials' classes
	 * and related rotations, that should be
	 * applied to the sky sphere static mesh
	 * together.
	 */
...
private:
	/**
	 * Is the card that the player is
	 * trying to open the first one?
	 * (There are no other opened cards on
	 * the map)
	 */
	 ...
	 * (There is one already opened card on
	 * the map)
	 */
	...
	/**
	 * Number of pairs that should
	 * be found by player on this level.
	 */
	...
	/**
	 * Number of cards' spins performed
	 ...
	 * @param CardsStylesToUse Array of cards' styles
	 * to use for spawning cards on the map.
	 */
	UFUNCTION()
...
public:
	/**
	 * Function for calling changing sky's
	 * material instance and rotation of its static
...
protected:
	/**
	 * Function for getting an asset pointer
	 * (soft reference) to sky material and
	 * a rotation that should be applied to
	 * the sky sphere static mesh by the name
	 * of the row from data table.
	 * @param DataTable Data table with the
	 * list of available sky materials.
	 * @param RowName The name of the row from
	 * data table, by which we should find
	 * information.
	 * @param OutReference Soft reference to
	 * the sky material.
	 * @param OutSkyStaticMeshRotation Rotation
	 * that should be applied to the sky sphere
	 * static mesh with the associated sky material.
	 */
	UFUNCTION()
	...
	/**
	 * Function for getting the list of cards'
	 * classes from the data table related to
	 * the particular cards' style.
	 * @param DataTable Data table with a list
	 * of cards' classes designed in the same
	 * style.
	 * @param OutReferences Array with the soft
	 * references to cards' classes from data
	 * table.
	 */
	UFUNCTION()
