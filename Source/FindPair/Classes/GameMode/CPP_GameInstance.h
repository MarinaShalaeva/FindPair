...
/**
 * Delegate for listening to the start of preparing
 * new level event.
 */
...
/**
 * Delegate for notifying that level was generated
 * and could be shown to the player.
 */
...
/**
 * Delegate for getting player's results array
 * from the save file.
 */
...
/**
 * Delegate for notifying that level's settings
 * should be saved to the save file.
 */
...
/**
 * Delegate for getting level's settings
 * from the save file.
 */
...
/**
 * Delegate for notifying that the save file
 * should be deleted.
 */
...
class FINDPAIR_API UCPP_GameInstance : public UGameInstance
{
	 ...
	 * should be applied when Game Instance
	...
	/**
	 * Function for storing logic that
	 * should be applied in the end of the Game
	 * Instance's life (but before its destroying).
	 */
...
public:
	...
	/**
	 * Delegate for listening to the start level
	 * event.
	 */
	...
	/**
	 * Delegate for getting player's results
	 * array from the save file.
	 */
	...
	/**
	 * Function for synchronous receiving class from
	 * the actor's soft reference.
	 * @param AssetPointer Soft reference to actor class.
	 * @return Class derived from the soft reference.
	 */
	UClass* GetAssetClassBySoftReference(const TAssetSubclassOf<AActor>& AssetPointer);

	/**
	 * Function for synchronous receiving class from
	 * the widget blueprint's soft reference.
	 * @param WidgetPointer Soft reference to widget
	 * blueprint.
	 * @return Class derived from the soft reference.
	 */
	UClass* GetWidgetClassBySoftReference(const TAssetSubclassOf<UUserWidget>& WidgetPointer);

	/**
	 * Function for synchronous receiving class from
	 * any given soft asset reference by using the asset
	 * loader.
